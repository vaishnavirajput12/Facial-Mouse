...
while True:
    ...
    if face_extractor(frame) is not None:
        ...
        file_name_path = "C:/Users/Vaishnavi Rajput/Downloads/aaafaceezip/aaafacee/Face-Recognition-Project-master/Face-Recognition-Project-master/sample"+str(count)+'.jpg'
